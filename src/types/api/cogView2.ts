...
export interface ICogView2Data {
  data: [null, string, [string, string, string, string, string, string, string]]
  duration: number
...
export class CogView2Response implements ICogView2Response, ICogView2Response {
  ...
  public getImageArray(): [string, string, string, string, string, string, string, string, string] {
    return this.data.data[2].map((e) => e.replace('data:image/png;base64,', '')) as any
  }
}
